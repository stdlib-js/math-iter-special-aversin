...
```javascript
iterAversin = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-aversin@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-aversin@umd/bundle.js"></script>
```
